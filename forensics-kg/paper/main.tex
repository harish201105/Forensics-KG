...
\thanks{\textit{Working draft compiled \today\ (rev.\ v12). Remove this note for camera-ready.}}%
}
...
a labelled $9{,}973$-pair benchmark, attains precision $0.96$ at the deliberately
conservative recall the setting demands (\cref{sec:resolution,sec:res_eval}).
