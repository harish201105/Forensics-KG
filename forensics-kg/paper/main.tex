...
% Distribute justification stretch within long URLs (e.g. the archived FBI
% SWGSTAIN link) instead of dumping it into the single space before the URL,
% which otherwise leaves an awkward gap after ``Available:'' in references.
...
\ifdraftstamp\thanks{\textit{Internal review copy compiled \today\ (rev.\ v25).}}\fi%
}
